  ...
  return (
    <header className={`header ${mobileMenu ? "mobileView" : ""} ${show}`}>
      <ContentWrapper>
        ...
        <li className="menuItem primine" onClick={() => navigate("/PlanForm")}>
          SUBSCRIBE
          </li>
          ...
          <Box display="flex" alignItems="center" gap={1} className="for_hide">
            <IconButton>
              <NotificationsOutlinedIcon className="text-white" onClick={NotificationOPen} />
            </IconButton>
