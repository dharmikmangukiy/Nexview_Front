...
export const Camera = ({ isLogin }) => {
    ...
    return (
        <div className="camera-container" style={{ backgroundImage: 'url("/images/camera.jpg")' }} ref={containerRef}>
            {(cameraStatus === 'opened') ?
                <>
                    ...
                    <div className="camera-face-overlay" style={{ borderColor: outline, }}>
                        <div className="camera-face-message" style={{ width: '166px', marginLeft: '-9px' }}>{message}</div>
                    </div>
                </>
                : isLogin ?
                    <img
            ...
            <Preview containerRef={containerRef} isLogin={isLogin} />
            <div
